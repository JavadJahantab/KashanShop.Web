        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaderCategoryId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Categories_LeaderCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SerilNum = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discount = table.Column<decimal>(type: "decimal(12,0)", precision: 12, scale: 0, nullable: false),
                    PricePaid = table.Column<decimal>(type: "decimal(12,0)", precision: 12, scale: 0, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    LastName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Titel = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    NewsText = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueOfField = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryNewsEnumerable", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategoryNewsEnumerable_News_NewsId",
                        column: x => x.NewsId,
                        principalTable: "News",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsPopularity", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NewsPopularity_News_NewsId",
                        column: x => x.NewsId,
                        principalTable: "News",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NewsPopularity_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsView", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NewsView_News_NewsId",
                        column: x => x.NewsId,
                        principalTable: "News",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NewsView_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPopularities", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductPopularities_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductFields_FieldValues_FieldValueId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionReplies_ProductQuestions_ProductQuestionId",
                        column: x => x.ProductQuestionId,
                        principalTable: "ProductQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionReplies_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_LeaderCategoryId",
                table: "Categories",
                column: "LeaderCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryNewsEnumerable_NewsId",
                table: "CategoryNewsEnumerable",
                column: "NewsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsPopularity_NewsId",
                table: "NewsPopularity",
                column: "NewsId");

            migrationBuilder.CreateIndex(
                name: "IX_NewsPopularity_UserId",
                table: "NewsPopularity",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_NewsView_NewsId",
                table: "NewsView",
                column: "NewsId");

            migrationBuilder.CreateIndex(
                name: "IX_NewsView_UserId",
                table: "NewsView",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductFields_FieldValueId",
                table: "ProductFields",
                column: "FieldValueId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPopularities_UserId",
                table: "ProductPopularities",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionReplies_ProductQuestionId",
                table: "QuestionReplies",
                column: "ProductQuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionReplies_UserId",
                table: "QuestionReplies",
                column: "UserId");
